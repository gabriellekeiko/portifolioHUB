...
Bem-vindo ao meu portfólio profissional de **Ciência de Dados e Machine Learning**. Este repositório centraliza minha jornada técnica, unindo projetos acadêmicos desenvolvidos no **CEUB** e estudos independentes sobre análise de dados e automação.

## Sobre o Portfólio
O objetivo deste HUB é demonstrar competências práticas em versionamento de código (Git), manipulação de dados com Python e criação de interfaces web estáticas.
